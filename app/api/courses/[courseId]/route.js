...
export async function GET(req, { params }) {
  try {
    ...
    console.log("Course being sent to client:", JSON.stringify(courseWithEnrollment, null, 2));
    ...
    return NextResponse.json(
      { error: "Failed to fetch course", details: error.message, stack: error.stack },
      { status: 500 }
    );
  }
}
